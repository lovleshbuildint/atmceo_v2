...
import 'token_update_model.dart';
export 'token_update_model.dart';

class TokenUpdateWidget extends StatefulWidget {
  const TokenUpdateWidget({Key? key}) : super(key: key);
...
class _TokenUpdateWidgetState extends State<TokenUpdateWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TokenUpdateModel());
