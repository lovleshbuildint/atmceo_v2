...
import 'testcom_model.dart';
export 'testcom_model.dart';

class TestcomWidget extends StatefulWidget {
  const TestcomWidget({Key? key}) : super(key: key);

  @override
  _TestcomWidgetState createState() => _TestcomWidgetState();
}

class _TestcomWidgetState extends State<TestcomWidget> {
  late TestcomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TestcomModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        ].divide(SizedBox(height: 1.0)).addToStart(SizedBox(height: 300.0)),
      ),
    );
  }
}
