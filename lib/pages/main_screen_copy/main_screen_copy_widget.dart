...
import 'main_screen_copy_model.dart';
export 'main_screen_copy_model.dart';

class MainScreenCopyWidget extends StatefulWidget {
  const MainScreenCopyWidget({Key? key}) : super(key: key);

  @override
  _MainScreenCopyWidgetState createState() => _MainScreenCopyWidgetState();
}

class _MainScreenCopyWidgetState extends State<MainScreenCopyWidget> {
  late MainScreenCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainScreenCopyModel());
