...
import 'all_a_t_m_filter_model.dart';
export 'all_a_t_m_filter_model.dart';

class AllATMFilterWidget extends StatefulWidget {
...
class _AllATMFilterWidgetState extends State<AllATMFilterWidget> {
  late AllATMFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllATMFilterModel());
  }
