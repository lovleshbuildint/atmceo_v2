...
import 'machine_dip_model.dart';
export 'machine_dip_model.dart';

class MachineDipWidget extends StatefulWidget {
  const MachineDipWidget({
    Key? key,
  ...
  @override
  _MachineDipWidgetState createState() => _MachineDipWidgetState();
}

class _MachineDipWidgetState extends State<MachineDipWidget> {
  late MachineDipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MachineDipModel());
  }
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              FFAppState().update(() {
                                FFAppState().sortByFilterTab = false;
                                FFAppState().reasonFilterTab = true;
                                FFAppState().gradeFilterTab = false;
                                FFAppState().uptimeTrendFilterTab = false;
                                FFAppState().transactionTrendFilterTab = false;
                                FFAppState().downTimeFilterTab = false;
                            ...
                            child: Container(
                              ...
                              height: 60.0,
                              decoration: BoxDecoration(
                                color: FFAppState().reasonFilterTab
                                    ? Colors.white
                                    : Color(0xFFF2F2F2),
                              ),
                              alignment: AlignmentDirectional(-1.00, 0.00),
                            ...
                            child: Text(
                              () {
                                if (FFAppState().sortByFilterTab) {
                                  ...
                                  return 'Location';
                                } else if (FFAppState().reasonFilterTab) {
                                  return 'Reasons';
                                } else {
                                  return '';
                                }
